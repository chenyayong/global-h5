        ...
        <view v-if="show">
            <view class="buy-type-box">
                <view v-show="!myself">
                    ...
                    <!-- <view class="buy-item">
                        ...
                        <view class="check-info"><input type="text" v-model="buy_name" placeholder="请填写报单人姓名" /></view>
                    </view> -->
                    <!-- <view class="buy-item">
            ...
            <!-- <view class="buy-type-box" v-show="!myself">
                <view class="buy-item no-show">
                    ...
                    <view class="check-info"><input type="text" v-model="service_id" placeholder="请填写服务商ID" /></view>
                </view>
            </view> -->
            ...
            <!-- <view class="page-mark flex-row bdb-1px">
                ...
                <input type="number" v-model="pay_points" @blur="getPayPoint" class="mark-input" :placeholder="'可用余额：' + user_money" placeholder-style="color:#999999" />
            </view> -->
...
export default {
    data() {
        return {
            ...
            pay_list: [
                ...
                //     name: '支付宝支付',
                //     code: 'alipayMobile',
                //     icon: '/plugins/payment/alipay/logo.png'
                // }
            ],
            timer: null,
            isSubmit: true,
    ...
    methods: {
        ...
        join_pay() {
            ...
            this.$http('get|api/join_pay/pay', {
                order_id: this.order_id
            })
                .then(res => {
                    // console.log(res)
